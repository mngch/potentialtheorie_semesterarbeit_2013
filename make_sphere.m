% make_sphere
% calculates coordinates for prisms building a sphere
% X,Y,Z coordinates center of sphere
% n number of edges
% d number of layers
% R radius of sphere
% e elliptcity
function [prism] = make_sphere(X,Y,Z,n,d,R,e)
...
l = 1;
for i = -pi/2:dd:pi/2     % all the polygon discs bottom to top
